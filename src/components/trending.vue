<template>
  ...
  >
    <input
      class="pl-12 rounded-full w-full p-2 bg-lighter placeholder:text-dark placeholder:font-normal mb-4"
      placeholder="Search Twitter"
    />
    <i
      class="fas fa-search absolute left-0 top-0 mt-5 ml-12 text-sm text-dark"
    ></i>
    ...
    <div class="w-full rounded-lg bg-lightest">
      ...
      <button
        class="p-3 w-full text-left text-blue hover:bg-lighter rounded-b-lg"
      >
        Show More
      </button>
    </div>
    ...
    <div
      v-if="getNotFollowedUsers.length"
      class="w-full rounded-lg bg-lightest my-4"
    >
      <p class="p-3 text-xl font-bold">Who to Follow</p>
      <button
        v-for="user in getNotFollowedUsers"
        :key="user.id"
        class="w-full flex hover:bg-lighter p-3"
      >
        <img
        ...
        <button
          ...
          class="rounded-full text-sm text-white font-medium ml-auto px-4 py-1 bg-black hover:bg-dark"
        >
          Follow
        </button>
      </button>
      <button
        @click="seeMoreUser()"
        class="p-3 w-full hover:bg-lighter text-left text-blue rounded-b-lg"
      >
        Show More
      </button>
    </div>
