<template>
  <div class="w-full md:w-1/2 h-full overflow-y-scroll">
    ...
    <div class="px-5 py-3 border-b border-lighter flex">
      <div class="flex-none">
        <router-link to='/profile'><img src="display-picture.png" class="flex-none w-12 h-12 rounded-full border border-lighter"/></router-link>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        following: this.$store.state.following,
